<html>
	<head> 
		...
		<link rel="stylesheet" href="styles/feedback3.css"/>
	</head>
	...
	<body>
		...
		<?php 
			...
			#insert data
			$sql="insert into reserve(apartmenttype,apartmentno,interest,fullname,reservation,nic,mobileno,email,info,contact,plantovisit)
				values('$Apartmenttype','$ApartNo','$Interests','$Fullname','$ReservationDate','$NIC','$MobileNo','$Email','$Information','$Contact','$Plantovisit')";
