<html>
	...
	<body>
		...
		<?php
			...
			//insert data
			$sql="insert into changingapartment(fullname,dob,nic,mobileno,email,changingtype,apartno,address,apartmenttype)
		...
		<?php
			...
			echo " 
			GENERAL POLICY:<br>
			The operation can be cancelled within 3 working days.<br>
			...
			Thankyou for choosing Niwahana Apartments.<br>"; 
